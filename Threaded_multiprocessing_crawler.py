...
def get_links(html, link_regex):
    ...
    webpage_regex = re.compile("""<a[^>]class="bookTitle".+href=["'](/book/show/[0-9]*\.[^?&;=]*)["']""", re.IGNORECASE)
...
def threaded_crawler_rq(start_url, link_regex, user_agent='pidp', proxies=None,
                        delay=2, max_depth=2, num_retries=1, cache=RedisCache(), max_threads=10, scraper_callback=None):
    ...
    robots = {}
    D = DownloadModule(delay=delay, user_agent=user_agent,
...
if __name__ == '__main__':
    ...
    mp_threaded_crawler("https://www.goodreads.com/list/show/264.Books_That_Everyone_Should_Read_At_Least_Once", par_args.url_pattern, num_procs=par_args.num_procs, max_threads=par_args.max_threads)
