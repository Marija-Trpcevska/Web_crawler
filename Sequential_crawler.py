...
def link_crawler(start_url, link_regex, robots_url=None, user_agent='pidp',
                 proxies=None, delay=2, max_depth=2, num_retries=1, cache={}, scraper_callback=None):
...
if __name__ == '__main__':
    ...
    start_time = time()
    link_crawler('https://www.goodreads.com/list/show/264.Books_That_Everyone_Should_Read_At_Least_Once?page=1', '', cache=RedisCache())
