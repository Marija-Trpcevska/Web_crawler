...
class DownloadModule:
    ...
    """
    def __init__(self, delay=5, user_agent='pidp', proxies=None, cache={}, timeout=60):
        self.throttle = ThrottleRequests(delay)
    ...
    def download(self, url, headers, proxies):
        """ Download and return the page content
            args:
                url (str): URL
