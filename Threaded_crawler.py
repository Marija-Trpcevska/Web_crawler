...
def threaded_crawler(start_url, link_regex, user_agent='pidp', proxies=None,
                     delay=2, max_depth=2, num_retries=1, cache={}, max_threads=10, scraper_callback=None): #max_depth=4 beshe
    ...
    seen, robots = {}, {}
    D = DownloadModule(delay=delay, user_agent=user_agent, proxies=proxies, cache=cache)
...
if __name__ == '__main__':
    ...
    threaded_crawler("https://www.goodreads.com/list/show/264.Books_That_Everyone_Should_Read_At_Least_Once?page=1", par_args.url_pattern, cache=RedisCache(),
